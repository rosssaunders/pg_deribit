create or replace function deribit.test_private_buy()
returns setof text
language plpgsql
as $$
declare
    _expected deribit.private_buy_response_result;
    
	_instrument_name text;
	_amount float;
	_type deribit.private_buy_request_type = null;
	_label text = null;
	_price float = null;
	_time_in_force deribit.private_buy_request_time_in_force = null;
	...
	_trigger deribit.private_buy_request_trigger = null;
	_advanced deribit.private_buy_request_advanced = null;
	_mmp boolean = null;
	_valid_until bigint = null;

begin
    _expected := deribit.private_buy(
