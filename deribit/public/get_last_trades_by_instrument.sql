...
create type deribit.public_get_last_trades_by_instrument_request_sorting as enum ('asc', 'desc', 'default');
...
begin
    ...
    _http_response := (select deribit.jsonrpc_request('/public/get_last_trades_by_instrument', _request));
