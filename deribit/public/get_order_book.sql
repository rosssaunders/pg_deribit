...
create type deribit.public_get_order_book_request_depth as enum ('1', '5', '10', '20', '50', '100', '1000', '10000');
...
begin
    ...
    _http_response := (select deribit.jsonrpc_request('/public/get_order_book', _request));
