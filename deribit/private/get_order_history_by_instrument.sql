...
values 
('private/get_order_history_by_instrument', now(), 0, '0 secs'::interval);
...
begin
    ...
    _http_response := deribit.internal_jsonrpc_request('/private/get_order_history_by_instrument', _request);
