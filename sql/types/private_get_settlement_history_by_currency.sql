...
create type deribit.private_get_settlement_history_by_currency_request_currency as enum ('BTC', 'USDC', 'ETH');

drop type if exists deribit.private_get_settlement_history_by_currency_request_type cascade;
create type deribit.private_get_settlement_history_by_currency_request_type as enum ('delivery', 'settlement', 'bankruptcy');
