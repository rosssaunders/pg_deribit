drop type if exists deribit.private_get_settlement_history_by_currency_response_settlement cascade;
...
comment on column deribit.private_get_settlement_history_by_currency_response_settlement.session_bankrupcy is 'value of session bankrupcy (in base currency; bankruptcy only)';
...
comment on column deribit.private_get_settlement_history_by_currency_response_settlement.session_tax_rate is 'rate of paid texes/fees (in base currency; bankruptcy only)';
...
drop type if exists deribit.private_get_settlement_history_by_currency_response_result cascade;
...
drop type if exists deribit.private_get_settlement_history_by_currency_response cascade;
...
create type deribit.private_get_settlement_history_by_currency_request_currency as enum ('ETH', 'BTC', 'USDC');

drop type if exists deribit.private_get_settlement_history_by_currency_request_type cascade;
create type deribit.private_get_settlement_history_by_currency_request_type as enum ('settlement', 'bankruptcy', 'delivery');
