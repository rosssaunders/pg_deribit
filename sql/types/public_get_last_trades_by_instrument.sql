drop type if exists deribit.public_get_last_trades_by_instrument_response_trade cascade;
...
comment on column deribit.public_get_last_trades_by_instrument_response_trade.amount is 'Trade amount. For perpetual and futures - in USD units, for options it is amount of corresponding cryptocurrency contracts, e.g., BTC or ETH.';
...
drop type if exists deribit.public_get_last_trades_by_instrument_response_result cascade;
...
drop type if exists deribit.public_get_last_trades_by_instrument_response cascade;
...
create type deribit.public_get_last_trades_by_instrument_request_sorting as enum ('default', 'desc', 'asc');
