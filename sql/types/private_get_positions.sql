...
create type deribit.private_get_positions_request_currency as enum ('ETH', 'BTC', 'USDC');

drop type if exists deribit.private_get_positions_request_kind cascade;
create type deribit.private_get_positions_request_kind as enum ('future', 'option_combo', 'future_combo', 'spot', 'option');
