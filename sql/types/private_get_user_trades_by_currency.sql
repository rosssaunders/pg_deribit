...
create type deribit.private_get_user_trades_by_currency_request_currency as enum ('USDC', 'ETH', 'BTC');

drop type if exists deribit.private_get_user_trades_by_currency_request_kind cascade;
create type deribit.private_get_user_trades_by_currency_request_kind as enum ('option', 'future_combo', 'combo', 'option_combo', 'spot', 'future', 'any');
