...
create type deribit.private_get_user_trades_by_currency_request_kind as enum ('combo', 'option', 'future', 'option_combo', 'any', 'spot', 'future_combo');

drop type if exists deribit.private_get_user_trades_by_currency_request_sorting cascade;
create type deribit.private_get_user_trades_by_currency_request_sorting as enum ('asc', 'default', 'desc');
