...
*/
drop type if exists deribit.public_exchange_token_response_result cascade;
...
drop type if exists deribit.public_exchange_token_response cascade;
...
drop type if exists deribit.public_exchange_token_request cascade;
