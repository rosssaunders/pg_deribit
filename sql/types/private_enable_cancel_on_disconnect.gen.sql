...
*/
drop type if exists deribit.private_enable_cancel_on_disconnect_response cascade;
...
drop type if exists deribit.private_enable_cancel_on_disconnect_request_scope cascade;
...
drop type if exists deribit.private_enable_cancel_on_disconnect_request cascade;
