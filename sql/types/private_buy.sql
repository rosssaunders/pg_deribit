...
create type deribit.private_buy_request_type as enum ('stop_limit', 'take_limit', 'trailing_stop', 'limit', 'take_market', 'stop_market', 'market_limit', 'market');

drop type if exists deribit.private_buy_request_time_in_force cascade;
create type deribit.private_buy_request_time_in_force as enum ('fill_or_kill', 'immediate_or_cancel', 'good_til_cancelled', 'good_til_day');
