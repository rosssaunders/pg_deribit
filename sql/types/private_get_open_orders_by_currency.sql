...
create type deribit.private_get_open_orders_by_currency_request_kind as enum ('future_combo', 'option', 'future', 'option_combo', 'spot');

drop type if exists deribit.private_get_open_orders_by_currency_request_type cascade;
create type deribit.private_get_open_orders_by_currency_request_type as enum ('trigger_all', 'stop_all', 'trailing_all', 'stop_limit', 'all', 'trailing_stop', 'take_limit', 'take_market', 'stop_market', 'limit', 'take_all');
