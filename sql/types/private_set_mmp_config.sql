...
create type deribit.private_set_mmp_config_request_index_name as enum ('btc_usd', 'link_usdc', 'eth_usdc', 'btcdvol_usdc', 'uni_usdc', 'avax_usdc', 'shib_usdc', 'mshib_usdc', 'btc_usdc', 'algo_usdc', 'ada_usdc', 'near_usdc', 'xrp_usdc', 'ethdvol_usdc', 'luna_usdc', 'trx_usdc', 'dot_usdc', 'matic_usdc', 'bnb_usdc', 'ltc_usdc', 'doge_usdc', 'bch_usdc', 'eth_usd');
