...
create type deribit.private_set_mmp_config_request_index_name as enum ('btcdvol_usdc', 'dot_usdc', 'bnb_usdc', 'luna_usdc', 'avax_usdc', 'algo_usdc', 'ltc_usdc', 'matic_usdc', 'doge_usdc', 'ada_usdc', 'link_usdc', 'near_usdc', 'bch_usdc', 'trx_usdc', 'mshib_usdc', 'btc_usdc', 'shib_usdc', 'uni_usdc', 'btc_usd', 'eth_usdc', 'eth_usd', 'xrp_usdc', 'ethdvol_usdc');
