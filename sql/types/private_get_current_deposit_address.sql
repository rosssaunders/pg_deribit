drop type if exists deribit.private_get_current_deposit_address_response_result cascade;
...
drop type if exists deribit.private_get_current_deposit_address_response cascade;
...
create type deribit.private_get_current_deposit_address_request_currency as enum ('ETH', 'BTC', 'USDC');
