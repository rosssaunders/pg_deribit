...
*/
drop type if exists deribit.private_get_cancel_on_disconnect_request_scope cascade;
...
drop type if exists deribit.private_get_cancel_on_disconnect_request cascade;
