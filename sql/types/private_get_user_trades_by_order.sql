drop type if exists deribit.private_get_user_trades_by_order_response cascade;
...
drop type if exists deribit.private_get_user_trades_by_order_request_sorting cascade;
create type deribit.private_get_user_trades_by_order_request_sorting as enum ('default', 'desc', 'asc');

drop type if exists deribit.private_get_user_trades_by_order_request cascade;
