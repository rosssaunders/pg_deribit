...
*/
drop type if exists deribit.public_get_combos_response_leg cascade;
...
drop type if exists deribit.public_get_combos_response_result cascade;
...
drop type if exists deribit.public_get_combos_response cascade;
...
drop type if exists deribit.public_get_combos_request_currency cascade;
...
drop type if exists deribit.public_get_combos_request cascade;

create type deribit.public_get_combos_request as (
    currency deribit.public_get_combos_request_currency
);

comment on column deribit.public_get_combos_request.currency is '(Required) The currency symbol';
