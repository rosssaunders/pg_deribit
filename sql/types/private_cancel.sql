drop type if exists deribit.private_cancel_response_result cascade;
...
drop type if exists deribit.private_cancel_response cascade;
...
drop type if exists deribit.private_cancel_request cascade;
