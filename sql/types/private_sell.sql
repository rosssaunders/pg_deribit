...
create type deribit.private_sell_request_type as enum ('stop_limit', 'trailing_stop', 'market', 'market_limit', 'take_limit', 'stop_market', 'limit', 'take_market');

drop type if exists deribit.private_sell_request_time_in_force cascade;
create type deribit.private_sell_request_time_in_force as enum ('fill_or_kill', 'good_til_day', 'good_til_cancelled', 'immediate_or_cancel');
