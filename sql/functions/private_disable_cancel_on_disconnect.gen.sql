...
*/
drop function if exists deribit.private_disable_cancel_on_disconnect;

create or replace function deribit.private_disable_cancel_on_disconnect(
...
as $$
    ...
    , http_response as (
        select deribit.internal_jsonrpc_request(
            '/private/disable_cancel_on_disconnect'::deribit.endpoint, 
            request.payload, 
