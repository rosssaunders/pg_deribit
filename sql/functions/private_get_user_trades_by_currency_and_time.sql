...
begin
    ...
    _http_response := deribit.internal_jsonrpc_request('/private/get_user_trades_by_currency_and_time'::deribit.endpoint, _request, 'deribit.non_matching_engine_request_log_call'::name);
