...
*/
drop function if exists deribit.private_enable_cancel_on_disconnect;

create or replace function deribit.private_enable_cancel_on_disconnect(
...
as $$
    ...
    , http_response as (
        select deribit.internal_jsonrpc_request(
            '/private/enable_cancel_on_disconnect'::deribit.endpoint, 
            request.payload, 
