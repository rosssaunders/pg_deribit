...
begin
    ...
    _http_response := deribit.internal_jsonrpc_request('/private/cancel_all_by_currency'::deribit.endpoint, _request, 'deribit.matching_engine_request_log_call'::name);
