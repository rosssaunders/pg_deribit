...
begin
    ...
    _http_response := deribit.internal_jsonrpc_request('/private/get_affiliate_program_info'::deribit.endpoint, null::text, 'deribit.non_matching_engine_request_log_call'::name);
