drop function if exists deribit.private_reset_api_key;
...
begin
    ...
    _http_response := deribit.internal_jsonrpc_request('/private/reset_api_key'::deribit.endpoint, _request, 'deribit.non_matching_engine_request_log_call'::name);
