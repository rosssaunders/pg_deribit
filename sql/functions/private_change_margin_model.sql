...
begin
    ...
    _http_response := deribit.internal_jsonrpc_request('/private/change_margin_model'::deribit.endpoint, _request, 'deribit.non_matching_engine_request_log_call'::name);
