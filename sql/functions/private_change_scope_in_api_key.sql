...
begin
    ...
    _http_response := deribit.internal_jsonrpc_request('/private/change_scope_in_api_key'::deribit.endpoint, _request, 'deribit.non_matching_engine_request_log_call'::name);
