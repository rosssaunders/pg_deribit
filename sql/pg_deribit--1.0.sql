...
as $$
    with http_response as (
        select deribit.private_jsonrpc_request(auth, '/private/create_subaccount'::deribit.endpoint, 
            null::text, 
...
as $$
    with http_response as (
        select deribit.private_jsonrpc_request(auth, '/private/enable_affiliate_program'::deribit.endpoint, 
            null::text, 
            'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
    )
...
comment on column deribit.private_get_account_summary_response_options_theta_map."total_delta_total_usd" is 'Optional (only for users using cross margin). The account''s total delta total in all cross collateral currencies, expressed in USD';
...
comment on column deribit.private_get_account_summary_response_options_vega_map."additional_reserve" is 'The account''s balance reserved in other orders';
...
as $$
    with http_response as (
        select deribit.private_jsonrpc_request(auth, '/private/get_new_announcements'::deribit.endpoint, 
            null::text, 
            'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
    )
...
as $$
    with http_response as (
        select deribit.private_jsonrpc_request(auth, '/private/get_pending_block_trades'::deribit.endpoint, 
            null::text, 
            'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
    )
...
as $$
    with http_response as (
        select deribit.private_jsonrpc_request(auth, '/private/get_user_locks'::deribit.endpoint, 
            null::text, 
            'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
    )
...
as $$
    with http_response as (
        select deribit.private_jsonrpc_request(auth, '/private/list_api_keys'::deribit.endpoint, 
            null::text, 
            'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
    )
...
create function deribit.private_unsubscribe(
    auth deribit.auth
,    "channels" text[]
)
returns setof text
...
as $$
    ...
    with request as (
        select row(
            "channels"
        )::deribit.private_unsubscribe_request as payload
    ), 
    http_response as (
        select deribit.private_jsonrpc_request(
            auth := auth,             
            url := '/private/unsubscribe'::deribit.endpoint, 
            request := request.payload, 
            rate_limiter := 'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
        from request
        ...
        , result as (
select (jsonb_populate_record(
                        null::deribit.private_unsubscribe_response,
                        convert_from((http_response.http_response).body, 'utf-8')::jsonb)
             ).result
        from http_response
    )
...
comment on function deribit.private_unsubscribe is 'Unsubscribe from one or more channels.';
/*
* AUTO-GENERATED FILE - DO NOT MODIFY
*
* This SQL file was generated by a code generation tool. Any modifications
...
* AND IS STRONGLY DISCOURAGED.
*/
create type deribit.private_unsubscribe_all_response as (
    "id" bigint,
    "jsonrpc" text,
    "result" text
);

comment on column deribit.private_unsubscribe_all_response."id" is 'The id that was sent in the request';
comment on column deribit.private_unsubscribe_all_response."jsonrpc" is 'The JSON-RPC version (2.0)';
comment on column deribit.private_unsubscribe_all_response."result" is 'Result of method execution. ok in case of success';

create function deribit.private_unsubscribe_all(
    auth deribit.auth
)
returns text
language sql
as $$
    with http_response as (
        select deribit.private_jsonrpc_request(auth, '/private/unsubscribe_all'::deribit.endpoint, 
            null::text, 
            'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
    )
select (jsonb_populate_record(
        null::deribit.private_unsubscribe_all_response, 
        convert_from((a.http_response).body, 'utf-8')::jsonb)).result
    from http_response a

$$;

comment on function deribit.private_unsubscribe_all is 'Unsubscribe from all the channels subscribed so far.';
/*
* AUTO-GENERATED FILE - DO NOT MODIFY
*
* This SQL file was generated by a code generation tool. Any modifications
...
create function deribit.public_auth(    "grant_type" deribit.public_auth_request_grant_type,
    "client_id" text,
    "client_secret" text,
    "refresh_token" text,
    "timestamp" bigint,
...
create function deribit.public_exchange_token(    "refresh_token" text,
    "subject_id" bigint
)
...
create function deribit.public_fork_token(    "refresh_token" text,
    "session_name" text
)
...
create function deribit.public_get_announcements(    "start_timestamp" bigint default null,
    "count" bigint default null
)
...
create function deribit.public_get_book_summary_by_currency(    "currency" deribit.public_get_book_summary_by_currency_request_currency,
...
create function deribit.public_get_book_summary_by_instrument(    "instrument_name" text
)
...
create function deribit.public_get_combo_ids(    "currency" deribit.public_get_combo_ids_request_currency,
...
create function deribit.public_get_combos(    "currency" deribit.public_get_combos_request_currency
)
...
create function deribit.public_get_contract_size(    "instrument_name" text
)
...
as $$
    with http_response as (
        select deribit.public_jsonrpc_request('/public/get_currencies'::deribit.endpoint, 
            null::text, 
            'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
    )
...
create function deribit.public_get_funding_chart_data(    "instrument_name" text,
    "length" deribit.public_get_funding_chart_data_request_length
)
...
create function deribit.public_get_historical_volatility(    "currency" deribit.public_get_historical_volatility_request_currency
)
...
create function deribit.public_get_index_price(    "index_name" deribit.public_get_index_price_request_index_name
)
...
as $$
    with http_response as (
        select deribit.public_jsonrpc_request('/public/get_index_price_names'::deribit.endpoint, 
            null::text, 
            'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
    )
...
create function deribit.public_get_instrument(    "instrument_name" text
)
...
create function deribit.public_get_instruments(    "currency" deribit.public_get_instruments_request_currency,
...
create function deribit.public_get_last_settlements_by_currency(    "currency" deribit.public_get_last_settlements_by_currency_request_currency,
...
create function deribit.public_get_last_trades_by_currency(    "currency" deribit.public_get_last_trades_by_currency_request_currency,
...
create function deribit.public_get_last_trades_by_currency_and_time(    "currency" deribit.public_get_last_trades_by_currency_and_time_request_currency,
    "start_timestamp" bigint,
    "end_timestamp" bigint,
...
create function deribit.public_get_last_trades_by_instrument(    "instrument_name" text,
    "start_seq" bigint default null,
    "end_seq" bigint default null,
    "start_timestamp" bigint default null,
    "end_timestamp" bigint default null,
...
create function deribit.public_get_last_trades_by_instrument_and_time(    "instrument_name" text,
    "start_timestamp" bigint,
    "end_timestamp" bigint,
    "count" bigint default null,
...
create function deribit.public_get_mark_price_history(    "instrument_name" text,
    "start_timestamp" bigint,
    "end_timestamp" bigint
)
returns setof text
...
create function deribit.public_get_order_book(    "instrument_name" text,
...
create function deribit.public_get_order_book_by_instrument_id(    "instrument_id" bigint,
...
create function deribit.public_get_rfqs(    "currency" deribit.public_get_rfqs_request_currency,
...
create function deribit.public_get_supported_index_names(    "type" deribit.public_get_supported_index_names_request_type default null
)
returns setof text
language sql
as $$
...
create function deribit.public_get_trade_volumes(    "extended" boolean default null
)
...
as $$
    with http_response as (
        select deribit.public_jsonrpc_request('/public/status'::deribit.endpoint, 
            null::text, 
            'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
    )
...
* AND IS STRONGLY DISCOURAGED.
*/
create type deribit.public_subscribe_request as (
    "channels" text[]
);

comment on column deribit.public_subscribe_request."channels" is '(Required) A list of channels to subscribe to.';

create type deribit.public_subscribe_response as (
    "id" bigint,
    "jsonrpc" text,
    "result" text[]
);

comment on column deribit.public_subscribe_response."id" is 'The id that was sent in the request';
comment on column deribit.public_subscribe_response."jsonrpc" is 'The JSON-RPC version (2.0)';
comment on column deribit.public_subscribe_response."result" is 'A list of subscribed channels.';

create function deribit.public_subscribe(    "channels" text[]
)
returns setof text
language sql
as $$
    ...
    http_response as (
        select deribit.public_jsonrpc_request(            
            url := '/public/subscribe'::deribit.endpoint, 
            request := request.payload, 
            rate_limiter := 'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
        from request
...
create function deribit.public_test(    "expected_result" deribit.public_test_request_expected_result default null
)
...
create function deribit.public_ticker(    "instrument_name" text
)
...
* AND IS STRONGLY DISCOURAGED.
*/
create type deribit.public_unsubscribe_all_response as (
    "id" bigint,
    "jsonrpc" text,
    "result" text
);

comment on column deribit.public_unsubscribe_all_response."id" is 'The id that was sent in the request';
comment on column deribit.public_unsubscribe_all_response."jsonrpc" is 'The JSON-RPC version (2.0)';
comment on column deribit.public_unsubscribe_all_response."result" is 'Result of method execution. ok in case of success';

create function deribit.public_unsubscribe_all(
)
returns text
language sql
as $$
    with http_response as (
        select deribit.public_jsonrpc_request('/public/unsubscribe_all'::deribit.endpoint, 
            null::text, 
            'deribit.non_matching_engine_request_log_call'::name
        ) as http_response
    )
select (jsonb_populate_record(
        null::deribit.public_unsubscribe_all_response, 
        convert_from((a.http_response).body, 'utf-8')::jsonb)).result
    from http_response a

$$;

comment on function deribit.public_unsubscribe_all is 'Unsubscribe from all the channels subscribed so far.';
